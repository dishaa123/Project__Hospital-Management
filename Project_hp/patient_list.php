    ...
    <div class="main-block">
        ...
        <div style="height:100%;background-color:green;">
            ...
            <center>
                ...
                <a style="margin-top: 25px;" href="add_patient.php">Add Patient</a>
                ...
                <?php } ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="update_patient.php?patient_id=<?php echo $row['id']?>">Update</a>
                            <a href="delete_patient.php?patient_id=<?php echo $row['id']?>">Delete</a>
                        </td>
                    </tr>
                    <?php } } else { ?>
