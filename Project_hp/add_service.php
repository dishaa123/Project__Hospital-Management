...
if(!empty($_POST)){
    ...
    print_r($_FILES);
    echo "</pre>";*/
    $insert_query = "INSERT INTO services (	`title`, `image`, `description`) VALUES ('".$_POST['title']."', '".$_FILES['image']['name']."','".$_POST['description']."')";
        ...
        <div style="height:100%;">
            ...
            <center>
                ...
                <form action="" class="main-block" method="post" enctype="multipart/form-data">
                        ...
                        <input type="text" name="title" id="title" placeholder="Service Title" required/><br><br>
                        <label id="icon" for="name">Description</label>
                        <textarea name="description" placeholder="Service Description" cols="8" row="8"></textarea><br><br>
