...
$services_data = $connection->query($select_query);
?>
<!DOCTYPE html>
<html>
  <head>
    ...
    <div class="main-block">
        ...
        <div style="height:100%;background-color:green;">
            ...
            <center>
                ...
                <a style="margin-top: 25px;" href="add_service.php">Add Service</a>
                <table border="1" style="margin:25px;left:50px;" cellspacing="15px" cellpadding="15px">
                <?php if($services_data->num_rows > 0) { ?>
                ...
                <?php } ?>
                    ...
                    {
                        while($row = $services_data->fetch_assoc())
                        {
                            //print_r($row);
                    ?>
                    <tr>
                        ...
                        <td>
                            <a href="update_service.php?service_id=<?php echo $row['id']?>">Update</a>
                            <a href="delete_service.php?service_id=<?php echo $row['id']?>">Delete</a>
                        </td>
                    </tr>
                    <?php } } else { ?>
